...
<div class="card">
	...
	<div class="card-header">
        ...
        <div class="float-right">
            ...
            <a class="btn btn-primary" href="{{ route('designation.index') }}"><i class="fa fa-table"></i> &nbsp;List All Designations</a>
        </div>
    </div>
	<div class="card-body">
        <div>
            <form action="{{ route('designation.update', $designation->id) }}" method="post">
                ...
                @method("PATCH")
                <label>Name</label></br>
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $designation->name) }}">
                @error('name')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('designation.destroy', $designation->id) }}" accept-charset="UTF-8" style="display:inline">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
