...
<div class="card">
	...
	<div class="card-header">
        ...
        <div class="float-left"><b>Utilities->Leave->Update</b></div>
            ...
            <form action="{{ route('leave.update', $leave->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label>Name</label></br>
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $leave->name) }}">
                        @error('name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="max_allowed_yearly" id="max_allowed_yearly" class="form-control @error('max_allowed_yearly') is-invalid @enderror" value="{{ old('max_allowed_yearly', $leave->max_allowed_yearly) }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('leave.destroy', $leave->id) }}" accept-charset="UTF-8" style="display:inline">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
