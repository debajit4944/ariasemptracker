...
@section('title')
<title>AriasEmpTracker - Resignation Details - Update</title>
@endsection('title')
...
<div class="card">
	...
	<div class="card-header">
        ...
        <div class="float-left"><b>Resignation Details -> Update</b></div>
	...
	<div class="card-body">
        <div>
        <form action="{{ route('employee_resignation.update', $resignation->id) }}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                @method("PATCH")
                    <input type="hidden" name="employees_id" id="employees_id" value="{{$resignation->employee_id}}">
                    <div class="row">
                        
                        <div class="col-md-6 mb-3">
                            <label for="resignation_effect_date">Effective Date:</label>
                            <input type="date" id="resignation_effect_date" name="resignation_effect_date" value="{{ old('resignation_effect_date', $resignation->resignation_effect_date) }}"class="form-control @error('resignation_effect_date') is-invalid @enderror">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('employee_resignation.destroy', $resignation->id) }}" accept-charset="UTF-8" style="display:inline">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
